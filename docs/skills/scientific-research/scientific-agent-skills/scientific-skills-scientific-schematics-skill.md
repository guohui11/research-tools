...
本地位置：`skills/scientific-research/scientific-agent-skills/scientific-skills/scientific-schematics/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/scientific-research/scientific-agent-skills/scientific-skills/scientific-schematics/SKILL.md`。
...
```text
请读取并使用 skills/scientific-research/scientific-agent-skills/scientific-skills/scientific-schematics/SKILL.md 这个 skill。
...
- **Gemini 3.1 Pro Preview reviews quality** against do

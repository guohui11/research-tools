...
本地位置：`skills/scientific-research/scientific-agent-skills/scientific-skills/scikit-survival/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/scientific-research/scientific-agent-skills/scientific-skills/scikit-survival/SKILL.md`。
...
```text
请读取并使用 skills/scientific-research/scientific-agent-skills/scientific-skills/scikit-survival/SKILL.md 这个 skill。
...
Survival analysis aims to establish connections between covariates and the time of an eve

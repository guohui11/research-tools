...
本地位置：`skills/scientific-research/scientific-agent-skills/scientific-skills/research-grants/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/scientific-research/scientific-agent-skills/scientific-skills/research-grants/SKILL.md`。
...
```text
请读取并使用 skills/scientific-research/scientific-agent-skills/scientific-skills/research-grants/SKILL.md 这个 skill。
...
**Critical Principle: Grants are persuasive docume

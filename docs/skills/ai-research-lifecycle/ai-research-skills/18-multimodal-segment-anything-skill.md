...
本地位置：`skills/ai-research-lifecycle/ai-research-skills/18-multimodal/segment-anything/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/ai-research-lifecycle/ai-research-skills/18-multimodal/segment-anything/SKILL.md`。
...
```text
请读取并使用 skills/ai-research-lifecycle/ai-research-skills/18-multimodal/segment-anything/SKILL.md 这个 skill。
...
- Processing medical, satellite, or domain-sp

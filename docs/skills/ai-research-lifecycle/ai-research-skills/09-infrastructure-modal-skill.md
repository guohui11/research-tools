...
本地位置：`skills/ai-research-lifecycle/ai-research-skills/09-infrastructure/modal/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/ai-research-lifecycle/ai-research-skills/09-infrastructure/modal/SKILL.md`。
...
```text
请读取并使用 skills/ai-research-lifecycle/ai-research-skills/09-infrastructure/modal/SKILL.md 这个 skill。
...
**Key features:**
- **Serverless GPUs**: T4, L4, A10G, L40S, A100, H1

...
本地位置：`skills/ai-research-lifecycle/ai-research-skills/19-emerging-techniques/long-context/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/ai-research-lifecycle/ai-research-skills/19-emerging-techniques/long-context/SKILL.md`。
...
```text
请读取并使用 skills/ai-research-lifecycle/ai-research-skills/19-emerging-techniques/long-context/SKILL.md 这个 skill。

...
本地位置：`skills/ai-research-lifecycle/ai-research-skills/08-distributed-training/accelerate/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/ai-research-lifecycle/ai-research-skills/08-distributed-training/accelerate/SKILL.md`。
...
```text
请读取并使用 skills/ai-research-lifecycle/ai-research-skills/08-distributed-training/accelerate/SKILL.md 这个 skill。

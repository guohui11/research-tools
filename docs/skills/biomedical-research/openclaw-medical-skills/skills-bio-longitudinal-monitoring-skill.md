...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/bio-longitudinal-monitoring/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/bio-longitudinal-monitoring/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/bio-longitudinal-monitoring/SKILL.md 这个 skill。
...
**"Track ctDNA levels over my patient's treatment"** → Monitor tumor fraction and mutation

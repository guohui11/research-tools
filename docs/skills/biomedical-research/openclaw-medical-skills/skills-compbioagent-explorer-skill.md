...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/compbioagent-explorer/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/compbioagent-explorer/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/compbioagent-explorer/SKILL.md 这个 skill。
...
1.  **Natural Language Querying**: "Show me the expression of TP53 in the B-c

...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/tooluniverse-rnaseq-deseq2/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/tooluniverse-rnaseq-deseq2/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/tooluniverse-rnaseq-deseq2/SKILL.md 这个 skill。
...
**BixBench Coverage**: Validated on 53 BixBench questions across 15 computational biology proj

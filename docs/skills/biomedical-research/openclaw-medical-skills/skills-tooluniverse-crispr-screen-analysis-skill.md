...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/tooluniverse-crispr-screen-analysis/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/tooluniverse-crispr-screen-analysis/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/tooluniverse-crispr-screen-analysis/SKILL.md 这个 skill。
...
CRISPR screens enable genome-wide functional genomics by systematically perturbing genes and measurin

...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/bio-alignment-msa-parsing/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/bio-alignment-msa-parsing/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/bio-alignment-msa-parsing/SKILL.md 这个 skill。
...
**Goal:** Load modules for parsing, analyzing, and manip

...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/prior-auth-coworker/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/prior-auth-coworker/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/prior-auth-coworker/SKILL.md 这个 skill。
...
3.  **Structured Output**: Returns a JSON object with dec

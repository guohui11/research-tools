...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/tooluniverse-gwas-snp-interpretation/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/tooluniverse-gwas-snp-interpretation/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/tooluniverse-gwas-snp-interpretation/SKILL.md 这个 skill。
...
- "Clinical significance of rs1801133" (MTHFR vari

...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/bio-causal-genomics-mediation-analysis/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/bio-causal-genomics-mediation-analysis/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/bio-causal-genomics-mediation-analysis/SKILL.md 这个 skill。
...
**"Test whether gene expression mediates the effect of this variant on disease"** → D

...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/bio-proteomics-data-import/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/bio-proteomics-data-import/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/bio-proteomics-data-import/SKILL.md 这个 skill。
...
**"Load my mass spec data into Python"** → Parse mzML/mzXML raw files or MaxQuant protei

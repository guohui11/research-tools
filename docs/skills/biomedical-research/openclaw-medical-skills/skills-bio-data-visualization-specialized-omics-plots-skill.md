...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/bio-data-visualization-specialized-omics-plots/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/bio-data-visualization-specialized-omics-plots/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/bio-data-visualization-specialized-omics-plots/SKILL.md 这个 skill。
...
- Survival curves
**For DESeq2/edgeR built-in functions** (plotMA, plotPCA, pl

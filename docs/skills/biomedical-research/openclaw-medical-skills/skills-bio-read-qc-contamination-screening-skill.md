...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/bio-read-qc-contamination-screening/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/bio-read-qc-contamination-screening/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/bio-read-qc-contamination-screening/SKILL.md 这个 skill。
...
Screen FASTQ files against multiple genomes to identify contamination sources using FastQ Scr

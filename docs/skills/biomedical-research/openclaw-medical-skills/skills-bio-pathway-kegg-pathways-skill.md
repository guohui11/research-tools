...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/bio-pathway-kegg-pathways/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/bio-pathway-kegg-pathways/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/bio-pathway-kegg-pathways/SKILL.md 这个 skill。
...
**Approach:** Test for enrichment using the hypergeometric test via clusterProfiler enrichKEGG aga

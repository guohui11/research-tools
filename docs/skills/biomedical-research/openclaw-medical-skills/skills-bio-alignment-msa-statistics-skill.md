...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/bio-alignment-msa-statistics/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/bio-alignment-msa-statistics/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/bio-alignment-msa-statistics/SKILL.md 这个 skill。
...
**Goal:** Load modules for alignment I/O, substitution scoring, and statistical calcula

...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/tooluniverse-multiomic-disease-characterization/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/tooluniverse-multiomic-disease-characterization/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/tooluniverse-multiomic-disease-characterization/SKILL.md 这个 skill。
...
---
Characterize diseases across multiple molecular layers (genomics, transcriptomics, proteomics, pathways) to provide systems-level understanding of disease mechanisms, identify therapeutic opportunities, and discover biomar

...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/bio-workflows-atacseq-pipeline/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/bio-workflows-atacseq-pipeline/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/bio-workflows-atacseq-pipeline/SKILL.md 这个 skill。
...
measurable_outcome: Execute skill workflow successfully with val

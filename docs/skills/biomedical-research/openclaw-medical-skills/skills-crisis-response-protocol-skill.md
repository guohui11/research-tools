...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/crisis-response-protocol/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/crisis-response-protocol/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/crisis-response-protocol/SKILL.md 这个 skill。
...
---
This skill helps you implement safe crisis intervention features for th

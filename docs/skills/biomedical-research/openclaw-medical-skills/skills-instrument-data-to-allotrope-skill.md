...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/instrument-data-to-allotrope/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/instrument-data-to-allotrope/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/instrument-data-to-allotrope/SKILL.md 这个 skill。
...
>
> This skill demonstrates how skills can support your data engineering tasks—

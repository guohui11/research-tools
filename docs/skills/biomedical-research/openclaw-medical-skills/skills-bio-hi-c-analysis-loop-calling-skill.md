...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/bio-hi-c-analysis-loop-calling/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/bio-hi-c-analysis-loop-calling/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/bio-hi-c-analysis-loop-calling/SKILL.md 这个 skill。
...
**"Call chromatin loops from my Hi-C data"** → Detec

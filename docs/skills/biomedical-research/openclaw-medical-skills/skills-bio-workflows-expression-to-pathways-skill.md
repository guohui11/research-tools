...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/bio-workflows-expression-to-pathways/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/bio-workflows-expression-to-pathways/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/bio-workflows-expression-to-pathways/SKILL.md 这个 skill。
...
- run_shell_command
---
Convert differential expression results into biological insights through functional enri

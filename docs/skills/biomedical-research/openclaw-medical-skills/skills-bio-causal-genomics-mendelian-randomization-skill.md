...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/bio-causal-genomics-mendelian-randomization/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/bio-causal-genomics-mendelian-randomization/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/bio-causal-genomics-mendelian-randomization/SKILL.md 这个 skill。
...
**"Test whether my exposure causally affects this outcome usi

...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/simulation-orchestrator/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/simulation-orchestrator/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/simulation-orchestrator/SKILL.md 这个 skill。
...
| Parameter ranges | Parameters to sweep with bounds | `dt:[1e-4,1e-2],kapp

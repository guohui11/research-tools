...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/mpn-research-assistant/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/mpn-research-assistant/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/mpn-research-assistant/SKILL.md 这个 skill。
...
|----------|--------------|-----------|------------------|
| JAK2V617F | 9p24.1 | Constitutive JAK-STAT a

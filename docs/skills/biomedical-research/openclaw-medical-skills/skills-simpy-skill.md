...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/simpy/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/simpy/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/simpy/SKILL.md 这个 skill。
...
- Comprehensive monitoring and data c

...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/tooluniverse-network-pharmacology/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/tooluniverse-network-pharmacology/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/tooluniverse-network-pharmacology/SKILL.md 这个 skill。
...
**IMPORTANT**: Always use English terms in tool calls (drug names, disease name

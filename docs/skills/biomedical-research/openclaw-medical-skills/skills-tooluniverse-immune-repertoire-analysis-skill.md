...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/tooluniverse-immune-repertoire-analysis/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/tooluniverse-immune-repertoire-analysis/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/tooluniverse-immune-repertoire-analysis/SKILL.md 这个 skill。
...
Adaptive immune receptor repertoire sequencing (AIRR-seq) enables comprehensive profiling of T-cell and B-cell populations through high-throughp

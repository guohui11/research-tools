...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/bio-molecular-io/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/bio-molecular-io/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/bio-molecular-io/SKILL.md 这个 skill。
...
**"Load my chemical library into Python"** → Parse molecular file formats (SMILES, SDF, MOL2, PDB) into

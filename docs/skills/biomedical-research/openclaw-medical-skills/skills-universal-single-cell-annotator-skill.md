...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/universal-single-cell-annotator/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/universal-single-cell-annotator/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/universal-single-cell-annotator/SKILL.md 这个 skill。
...
2.  **Deep Learning Reference**: Wraps `celltypist` to transfer labels from massive atlas

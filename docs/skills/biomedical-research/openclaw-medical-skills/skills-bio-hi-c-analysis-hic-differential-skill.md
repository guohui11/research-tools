...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/bio-hi-c-analysis-hic-differential/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/bio-hi-c-analysis-hic-differential/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/bio-hi-c-analysis-hic-differential/SKILL.md 这个 skill。
...
**"Compare Hi-C contacts between my conditions"** → Compute log2 fold-change contact maps, ident

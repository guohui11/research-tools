...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/bio-tumor-fraction-estimation/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/bio-tumor-fraction-estimation/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/bio-tumor-fraction-estimation/SKILL.md 这个 skill。
...
**"Estimate tumor fraction from my cfDNA da

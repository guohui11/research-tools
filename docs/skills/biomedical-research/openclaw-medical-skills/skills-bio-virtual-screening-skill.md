...
本地位置：`skills/biomedical-research/openclaw-medical-skills/skills/bio-virtual-screening/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/biomedical-research/openclaw-medical-skills/skills/bio-virtual-screening/SKILL.md`。
...
```text
请读取并使用 skills/biomedical-research/openclaw-medical-skills/skills/bio-virtual-screening/SKILL.md 这个 skill。
...
**"Dock my compound library against a protein target"** → Perform structure-based virtual sc

...
本地位置：`skills/academic-writing/paper-spine/dist/codex/skills/paper-spine/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/academic-writing/paper-spine/dist/codex/skills/paper-spine/SKILL.md`。
...
```text
请读取并使用 skills/academic-writing/paper-spine/dist/codex/skills/paper-spine/SKILL.md 这个 skill。

...
本地位置：`skills/academic-writing/paper-spine/dist/claude/skills/paper-spine-humanize/SKILL.md`
...
2. 指定本地 skill 文件路径：`skills/academic-writing/paper-spine/dist/claude/skills/paper-spine-humanize/SKILL.md`。
...
```text
请读取并使用 skills/academic-writing/paper-spine/dist/claude/skills/paper-spine-humanize/SKILL.md 这个 skill。

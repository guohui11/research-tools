...
- 上游：[Orchestra-Research/AI-research-SKILLs](https://github.com/Orchestra-Research/AI-research-SKILLs)
- 本地内容：`skills/ai-research-lifecycle/ai-research-skills`
- 使用文档：`docs/skills/ai-research-lifecycle/ai-research-skills/README.md`
- 自动发现 skill 数量：98
- 简介：围绕 AI 研究生命周期构建的技能集合，覆盖文献综述、想法生成、实验设计、训练评估、结果分析和论文写作。
- 适合：做机器学习、深度学习、LLM、Agent 或数据科学课题的研究生。

## 生物医学研究 Skills

### OpenClaw-Medical-Skills

- 上游：[FreedomIntelligence/OpenClaw-Medical-Skills](https://github.com/FreedomIntelligence/OpenClaw-Medical-Skills)
- 本地内容：`skills/biomedical-research/openclaw-medical-skills`
- 使用文档：`docs/skills/biomedical-research/openclaw-medical-skills/README.md`
- 自动发现 skill 数量：897
